**本应用用于安卓用户在本地阅读崩三的三部视觉小说，Windows端用户可下载 https://github.com/Escosis/BH3-Visual-Novels 下的所有文件并以以下方法打开进行阅读：（也可以直接访问 https://escosis.github.io/BH3-Visual-Novels/ 进行预览。）**
